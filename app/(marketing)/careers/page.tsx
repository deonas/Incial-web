  ...
  return (
    <Link href={`/careers/${job.slug}`} className="group block">
      <div className="border border-white/10 rounded-2xl px-6 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:border-white/30 hover:bg-white/5 transition-all duration-300">
        <div>
          <p className="text-[11px] uppercase tracking-widest text-gray-500 mb-1">{job.department}</p>
          <h3 className="text-[17px] font-semibold text-white group-hover:text-blue-400 transition-colors">{job.title}</h3>
          <p className="text-[13px] text-gray-400 mt-1">{job.location} · {job.type}</p>
        </div>
        <span className="text-sm text-blue-400 font-medium shrink-0 group-hover:underline">View role →</span>
      </div>
    </Link>
  );
}
  ...
  return (
    ...
    >
      <p className="text-[12px] text-gray-300 italic leading-relaxed max-w-[75%]">
        "Our culture values respect, curiosity, and continuous learning. We create space for fresh ideas and ensure that every voice contributes to shaping our journey."
      </p>
      <div className="text-right shrink-0 flex flex-col justify-start pt-0.5">
        <p className="text-[12px] text-white font-medium">~ Abidh<br />Habeeb</p>
        <Link href="#" className="text-[11px] text-blue-400 hover:underline mt-0.5">CEO | Incial</Link>
      </div>
    </motion.div>
  );
}
...
function LinkedInBadge({ href }: { href: string }) {
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 24 24">
      ...
      <main className="pt-24 pb-32">
        ...
        <div className="mx-auto w-full max-w-[1100px] px-10 md:px-20">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-16">
              <FadeIn delay={0.1} className="md:w-[38%] shrink-0">
                <p className="text-[20px] md:text-[22px] font-bold leading-snug">
                  We're not just building brands: we're building a team that loves Mondays.{" "}
                  <span className="italic text-blue-400">(most of the time)</span>
                </p>
              </FadeIn>
          ...
          <section className="mb-6">
            <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-16">
              <FadeIn delay={0.1} className="md:w-[38%] shrink-0">
                <h2 className="text-2xl md:text-[26px] font-bold">Current Openings</h2>
              </FadeIn>
              <FadeIn delay={0.2} className="md:w-[55%]">
                {jobs.length === 0 ? (
                  <p className="text-[12px] md:text-[13px] text-gray-300 leading-relaxed">
                    We're growing fast, but at the moment, there are no open positions. However, we're always eager to connect with passionate individuals who share our values and creativity.
                  </p>
                ) : (
          ...
          <FadeIn delay={0.3} className="mb-24">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <p className="text-[12px] text-gray-400 italic">
                If that sounds like you, send us your portfolio or resume — we'd love to stay in touch.
              </p>
              <div className="flex items-center gap-3 shrink-0">
                <a href="mailto:careers@incial.in" className="text-[12px] text-blue-400 hover:underline">careers@incial.in</a>
        ...
        <section className="px-6 md:px-10 max-w-[1320px] mx-auto mb-16">
          <FadeIn>
            <div
              ...
              style={{ paddingTop: "40px", paddingBottom: "40px", paddingLeft: "82px", paddingRight: "82px", gap: "16px" }}
            >
              <h2 className="text-black whitespace-nowrap"
                style={{ fontFamily: "var(--font-poppins)", fontWeight: 700, fontSize: "36px", lineHeight: "100%", letterSpacing: 0, textAlign: "center" }}>
                Life at Incial
              </h2>
              <p className="text-gray-500 whitespace-nowrap"
                style={{ fontFamily: "var(--font-poppins)", fontWeight: 400, fontStyle: "italic", fontSize: "16px", lineHeight: "100%", letterSpacing: 0, textAlign: "center" }}>
                Work at Incial goes beyond deliverables — it's about collaboration, innovation, and growth.
              </p>
            </div>
          </FadeIn>
        </section>
        ...
        {/* ── Culture quote ─────────────────────────────────────────────── */}
        <FadeIn delay={0.1} className="px-10 md:px-20 max-w-[1100px] mx-auto mb-20 text-center">
        ...
        <section className="px-10 md:px-20 max-w-[1100px] mx-auto">
          ...
          <FadeIn delay={0.25}>
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-[13px]">
              <a href="mailto:careers@incial.in" className="text-blue-400 hover:underline">careers@incial.in</a>
              <span className="text-gray-600">|</span>
              <a href="https://linkedin.com/company/incial" target="_blank" rel="noopener noreferrer"
