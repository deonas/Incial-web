...
export default function ExperienceSlide() {
  return (
    <div className="relative flex h-full w-full items-center justify-between px-10 md:px-32">
      ...
      <div className="flex flex-col items-end text-right z-10 mr-10 md:mr-32">
        <motion.h2
